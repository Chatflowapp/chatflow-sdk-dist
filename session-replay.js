(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SessionReplay = {}));
    ...
    ***************************************************************************** */
    ...
    let customAlphabet$1$1 = (alphabet, defaultSize = 21) => {
    ...
    var nonSecure$1$1 = { nanoid: nanoid$1$1$1, customAlphabet: customAlphabet$1$1 };
    ...
    let customAlphabet$2 = (alphabet, defaultSize = 21) => {
      return (size = defaultSize) => {
        let id = "";
        let i2 = size;
        while (i2--) {
    ...
    var nonSecure$2 = { nanoid: nanoid$1$2, customAlphabet: customAlphabet$2 };
    ...
    class BaseRRNode$1 {
      ...
      contains(node2) {
        if (!(node2 instanceof BaseRRNode$1)) return false;
    ...
    const utils = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
      __proto__: null,
      StyleSheetMirror: StyleSheetMirror$1,
      get _mirror() {
        return _mirror$1;
      },
      closestElementOfNode: closestElementOfNode$1,
      getBaseDimension,
      getNestedRule,
      getPositionsAndIndex,
      getRootShadowHost: getRootShadowHost$1,
      getShadowHost: getShadowHost$1,
      getWindowHeight: getWindowHeight$1,
      getWindowScroll: getWindowScroll$1,
      getWindowWidth: getWindowWidth$1,
      hasShadowRoot: hasShadowRoot$1,
      hookSetter: hookSetter$1,
      inDom: inDom$1,
      isAncestorRemoved: isAncestorRemoved$1,
      isBlocked: isBlocked$1,
      isIgnored: isIgnored$1,
      isSerialized: isSerialized$1,
      isSerializedIframe: isSerializedIframe$1,
      isSerializedStylesheet: isSerializedStylesheet$1,
      iterateResolveTree,
      legacy_isTouchEvent: legacy_isTouchEvent$1,
      get nowTimestamp() {
        return nowTimestamp$1;
      },
      on: on$1,
      patch: patch$1,
      polyfill: polyfill$1$1,
      queueToResolveTrees,
      shadowHostInDom: shadowHostInDom$1,
      throttle: throttle$1,
      uniqueTextMutations
    }, Symbol.toStringTag, { value: "Module" }));
    ...
    typeof window !== "undefined" && window.Blob && new Blob([decodeBase64$1(encodedJs$1)], { type: "text/javascript;charset=utf-8" });
    try {
    ...
    class StackFrame {
      constructor(obj) {
        __publicField$2(this, "fileName");
        __publicField$2(this, "functionName");
        __publicField$2(this, "lineNumber");
        __publicField$2(this, "columnNumber");
    ...
    var SESSION_KEYS = {
        SESSION_ID: 'cf-analytics-session-id',
        LAST_UPDATE: 'cf-analytics-last-update',
        VISITOR_ID: 'cf-analytics-visitor-id'
    };
    var SessionReplay = /** @class */ (function () {
        function SessionReplay(options) {
            ...
            this.MAX_REQUESTS_PER_MINUTE = ((_a = options.batchingOptions) === null || _a === void 0 ? void 0 : _a.maxRequestsPerMinute) || 30;
            this.DEBOUNCE_DELAY = ((_b = options.batchingOptions) === null || _b === void 0 ? void 0 : _b.debounceDelay) || 1000;
            this.MIN_BATCH_SIZE = ((_c = options.batchingOptions) === null || _c === void 0 ? void 0 : _c.minBatchSize) || 20;
            this.MAX_BATCH_SIZE = ((_d = options.batchingOptions) === null || _d === void 0 ? void 0 : _d.maxBatchSize) || 100;
            this.ADAPTIVE_BATCHING = (_f = (_e = options.batchingOptions) === null || _e === void 0 ? void 0 : _e.adaptiveBatching) !== null && _f !== void 0 ? _f : true;
            this.ENABLE_MOUSE_FILTERING = (_h = (_g = options.eventFiltering) === null || _g === void 0 ? void 0 : _g.enableMouseMovementFiltering) !== null && _h !== void 0 ? _h : true;
            this.MOUSE_THROTTLE_MS = ((_j = options.eventFiltering) === null || _j === void 0 ? void 0 : _j.mouseMovementThrottleMs) || 50;
            this.ENABLE_SCROLL_FILTERING = (_l = (_k = options.eventFiltering) === null || _k === void 0 ? void 0 : _k.enableScrollFiltering) !== null && _l !== void 0 ? _l : true;
            this.SCROLL_THROTTLE_MS = ((_m = options.eventFiltering) === null || _m === void 0 ? void 0 : _m.scrollThrottleMs) || 100;
            this.ENABLE_RESIZE_FILTERING = (_p = (_o = options.eventFiltering) === null || _o === void 0 ? void 0 : _o.enableResizeFiltering) !== null && _p !== void 0 ? _p : true;
            this.RESIZE_THROTTLE_MS = ((_q = options.eventFiltering) === null || _q === void 0 ? void 0 : _q.resizeThrottleMs) || 200;
            this.logger.info('SessionReplay: Initializing with optimizations...', {
                maxRequestsPerMinute: this.MAX_REQUESTS_PER_MINUTE,
                debounceDelay: this.DEBOUNCE_DELAY,
                adaptiveBatching: this.ADAPTIVE_BATCHING
            });
            this.setupVisibilityListener();
            this.sessionValidate().then(function () {
                _this.startRecording();
            });
        }
        SessionReplay.prototype.createDefaultLogger = function () {
            return {
                debug: function () { },
                info: function () { },
                warn: function () { },
        ...
        SessionReplay.prototype.sessionValidate = function () {
            return __awaiter(this, void 0, void 0, function () {
                var ONE_HOUR_MS, sessionId, lastUpdate, shouldValidate, data, response, result, error_1;
                var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        case 0:
                            if (!this.options.apiURL) {
                                this.logger.error('apiURL is required in options.');
                                return [2 /*return*/];
                            }
                            ONE_HOUR_MS = 36e5;
                            _l.label = 1;
                        case 1:
                            ...
                            lastUpdate = sessionStorage.getItem(SESSION_KEYS.LAST_UPDATE);
                            shouldValidate = !sessionId || !lastUpdate ||
                                (Date.now() - parseInt(lastUpdate, 10)) / ONE_HOUR_MS > 1;
                            if (!shouldValidate) return [3 /*break*/, 4];
                            this.logger.info('Validating session...');
                            data = {
                                key: this.options.workspaceId,
                                ts: Date.now(),
                                lc: navigator.language,
                                perf: {
                                    conn: ((_a = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _a === void 0 ? void 0 : _a.connectEnd) - ((_b = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _b === void 0 ? void 0 : _b.connectStart),
                                    dns: ((_c = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _c === void 0 ? void 0 : _c.domainLookupEnd) - ((_d = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _d === void 0 ? void 0 : _d.domainLookupStart),
                                    dom_load: ((_e = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _e === void 0 ? void 0 : _e.domComplete) - ((_f = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _f === void 0 ? void 0 : _f.domLoading),
                                    page_load: ((_g = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _g === void 0 ? void 0 : _g.loadEventEnd) - ((_h = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _h === void 0 ? void 0 : _h.navigationStart),
                                    render: ((_j = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _j === void 0 ? void 0 : _j.domInteractive) - ((_k = performance === null || performance === void 0 ? void 0 : performance.timing) === null || _k === void 0 ? void 0 : _k.domLoading),
                                },
                            };
                            return [4 /*yield*/, fetch("".concat(this.options.apiURL, "/analytics/web/psid"), {
                                    method: 'POST',
                                    headers: {
                        ...
                        case 3:
                            ...
                            if (result === null || result === void 0 ? void 0 : result.payload) {
                                sessionStorage.setItem(SESSION_KEYS.SESSION_ID, result.payload.sessionId);
                                sessionStorage.setItem(SESSION_KEYS.LAST_UPDATE, Date.now().toString());
                                sessionStorage.setItem(SESSION_KEYS.VISITOR_ID, result.payload.visitorId);
                                this.logger.info('Session validated successfully', { sessionId: result.payload.sessionId });
                            }
                            else {
                                this.logger.warn('Session validation response missing payload');
                            }
                            return [3 /*break*/, 5];
                        case 4:
                            this.logger.debug('Session validation skipped - session still valid');
                            _l.label = 5;
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            error_1 = _l.sent();
                            this.logger.error('Failed to validate session:', error_1);
                            return [3 /*break*/, 7];
        ...
        SessionReplay.prototype.shouldFilterEvent = function (event) {
            var now = Date.now();
            if (this.ENABLE_MOUSE_FILTERING && event.type === 3) {
                if (now - this.lastMouseEvent < this.MOUSE_THROTTLE_MS) {
                    return true;
                }
                this.lastMouseEvent = now;
            }
            if (this.ENABLE_SCROLL_FILTERING && event.type === 4) {
                if (now - this.lastScrollEvent < this.SCROLL_THROTTLE_MS) {
                    return true;
                }
                this.lastScrollEvent = now;
            }
            if (this.ENABLE_RESIZE_FILTERING && event.type === 5) {
                if (now - this.lastResizeEvent < this.RESIZE_THROTTLE_MS) {
                    return true;
                }
        ...
        SessionReplay.prototype.getAdaptiveBatchSize = function () {
            if (!this.ADAPTIVE_BATCHING) {
                return this.MIN_BATCH_SIZE;
            }
            var recentEvents = this.events.slice(-10);
            var avgTimeBetweenEvents = recentEvents.length > 1
                ? (recentEvents[recentEvents.length - 1].timestamp - recentEvents[0].timestamp) / (recentEvents.length - 1)
                : 1000;
            if (avgTimeBetweenEvents < 100) {
                return Math.min(this.MAX_BATCH_SIZE, this.MIN_BATCH_SIZE * 2);
            }
            else if (avgTimeBetweenEvents < 500) {
                return this.MIN_BATCH_SIZE;
            }
            else {
                return Math.max(10, this.MIN_BATCH_SIZE / 2);
            }
        };
        SessionReplay.prototype.canMakeRequest = function () {
            var now = Date.now();
        ...
        SessionReplay.prototype.scheduleSend = function () {
            var _this = this;
            if (this.sendTimeout) {
        ...
        SessionReplay.prototype.startRecording = function () {
            var _this = this;
            if (!this.isTabActive) {
                this.logger.debug('Not starting recording - tab is inactive');
                return;
            }
            this.logger.info('Starting session recording with optimizations...');
            this.stopRecording = record({
                emit: function (event) {
                    if (!_this.isTabActive) {
                        _this.logger.debug('Event ignored - tab is inactive', { eventType: event.type });
                        return;
                    }
                    if (_this.shouldFilterEvent(event)) {
                        _this.logger.debug('Event filtered', { eventType: event.type });
                        return;
                    }
                    _this.events.push(event);
                    _this.logger.debug('Event recorded', { eventType: event.type, totalEvents: _this.events.length });
                    var batchSize = _this.getAdaptiveBatchSize();
                    if (_this.events.length >= batchSize) {
                        _this.scheduleSend();
                    }
                },
        ...
        SessionReplay.prototype.sendEvents = function () {
            return __awaiter(this, void 0, void 0, function () {
                var eventsToSend, response, error_2;
                var _a, _b;
                var _this = this;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            if (!this.events.length || this.isSending) {
                                this.logger.debug('No events to send or already sending');
                                return [2 /*return*/];
                            }
                            if (!this.options.apiURL) {
                                this.logger.error('apiURL is required in options.');
                            ...
                            if (!this.canMakeRequest()) {
                                this.logger.warn('Rate limit exceeded, scheduling retry...');
                                this.scheduleSend();
                                return [2 /*return*/];
                            }
                            this.isSending = true;
                            ...
                            this.logger.info('Sending events...', {
                                eventCount: this.events.length,
                                batchSize: this.getAdaptiveBatchSize(),
                                requestCount: this.requestCount
                            });
                            return [4 /*yield*/, this.sessionValidate()];
                        case 1:
                            _c.sent();
                            eventsToSend = __spreadArray([], this.events, true);
                            if (this.options.onBeforeSend) {
                                this.logger.debug('Processing events with onBeforeSend hook');
                                eventsToSend = this.options.onBeforeSend(eventsToSend);
                            }
                            if (!eventsToSend.length) return [3 /*break*/, 6];
                            _c.label = 2;
                        case 2:
                            _c.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, fetch("".concat(this.options.apiURL, "/analytics/web/collect"), {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'X-SESSION-ID': getPSID() || '',
                                    },
                                    body: JSON.stringify({ events: eventsToSend, psid: getPSID() }),
                                })];
                        case 3:
                            response = _c.sent();
                            if (response.ok) {
                                this.logger.info('Events sent successfully', {
                                    sentCount: eventsToSend.length,
                                    remainingInQueue: this.events.length - eventsToSend.length
                                });
                                this.events = [];
                                if (this.failedEvents.length > 0) {
                                    this.logger.info('Retrying failed events...', { failedCount: this.failedEvents.length });
                                    this.events = __spreadArray([], this.failedEvents, true);
                                    this.failedEvents = [];
                                    this.scheduleSend();
                                }
                            }
                            else {
                                this.logger.error('Failed to send events', {
                                    status: response.status,
                                    statusText: response.statusText,
                                    eventsInQueue: this.events.length
                                });
                                (_a = this.failedEvents).push.apply(_a, eventsToSend);
                                this.events = this.events.filter(function (e) { return !eventsToSend.includes(e); });
                                ...
                                this.retryTimeout = setTimeout(function () {
                                    ...
                                    _this.scheduleSend();
                                }, Math.min(5000 * Math.pow(2, this.failedEvents.length / 10), 30000));
                            }
                            return [3 /*break*/, 5];
                        case 4:
                            error_2 = _c.sent();
                            this.logger.error('Error sending events:', error_2, { eventsInQueue: this.events.length });
                            (_b = this.failedEvents).push.apply(_b, eventsToSend);
                            this.events = this.events.filter(function (e) { return !eventsToSend.includes(e); });
                            if (this.retryTimeout) {
                                clearTimeout(this.retryTimeout);
                            }
                        ...
                        case 5: return [3 /*break*/, 7];
                        case 6:
                            this.logger.debug('No events to send after processing', { eventsInQueue: this.events.length });
                            _c.label = 7;
                        case 7:
                            this.isSending = false;
                            return [2 /*return*/];
        ...
        SessionReplay.prototype.getPSID = function () {
            return getPSID();
        };
        SessionReplay.prototype.getLogger = function () {
            return this.logger;
        };
        SessionReplay.prototype.getStats = function () {
            return {
                eventsInQueue: this.events.length,
        ...
        SessionReplay.prototype.flush = function () {
            if (this.events.length > 0) {
                this.sendEvents();
            }
        };
        SessionReplay.prototype.setupVisibilityListener = function () {
            var _this = this;
            if (typeof document !== 'undefined') {
                var handleVisibilityChange = function () {
                    var wasActive = _this.isTabActive;
                    _this.isTabActive = !document.hidden;
                    if (wasActive && !_this.isTabActive) {
                        _this.logger.info('Tab became inactive, pausing event recording');
                        _this.pauseRecording();
                    }
                    else if (!wasActive && _this.isTabActive) {
                        _this.logger.info('Tab became active, resuming event recording');
        ...
        SessionReplay.prototype.pauseRecording = function () {
            if (this.stopRecording) {
                this.stopRecording();
                this.stopRecording = null;
                this.logger.debug('Recording paused due to inactive tab');
            }
        };
        SessionReplay.prototype.resumeRecording = function () {
            if (!this.stopRecording && this.isTabActive) {
                this.startRecording();
                this.logger.debug('Recording resumed due to active tab');
            }
        };
        return SessionReplay;
    }());
    function initSessionReplay(options) {
